/*
 * ${file_name} of project cpdetector, <purpose> Copyright ${year} (C) Achim
 * Westermann, created on 03.06.2004.
 * 
 * ***** BEGIN LICENSE BLOCK ***** Version: MPL 1.1/GPL 2.0/LGPL 2.1
 * 
 * The contents of this collection are subject to the Mozilla Public License
 ...
 * 
 * The Original Code is the cpDetector code in [sub] packages info.monitorenter
 * and cpdetector.
 * 
 * The Initial Developer of the Original Code is Achim Westermann
 * <achim.westermann@gmx.de>.
 * 
 * Portions created by the Initial Developer are Copyright (c) 2007 the Initial
...
public final class CodepageDetectorProxy extends AbstractCodepageDetector {
     ...
     * delegate to. These instances will be invoked in order to find the
     * codepage until the first instance returns a valid codepage. If an
    ...
    /**
     * Clear all the detectors added to this instance
     */
    ...
    /**
     * @param url
     *            Should link to a file containing textual document. No check
     *            for images or other resources is made.
     * @throws IOException
